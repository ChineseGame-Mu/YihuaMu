  ...
  return (
    <>
      ...
      >
        ...
        <p>
          把房间链接发送给其他玩家；至少 4 名正式玩家进入同一房间后，才会出现“开始游戏”按钮。
        </p>
        ...
        <ul>
          ...
          <li>主要游戏界面改为简体中文。</li>
          <li>
            3–8 副牌启用 YihuaMu 特殊跟牌规则：首家出 4 张同花色组合或相应拖拉机时，跟家只有 3 张该花色且其中有一对，不再强制必须把该对子跟出。
          </li>
        ...
        <ul>
          <li>
            原版加入 4 副及以上牌局的炸弹牌支持；相关功能可在更多游戏设置中配置。
          </li>
        </ul>
      </ReactModal>
    </>
