...
const GuandanCustomSortControls: React.FunctionComponent = () => {
  ...
  const globalStyles = (
    <style>{`
      ...
      .guandan-private-zone>.guandan-play-actions>.guandan-play-action{left:14px!important;right:auto!important;border-color:#fff0a5!important;background:linear-gradient(180deg,#ffe16a 0%,#ffb313 100%)!important;color:#4b2b00!important;box-shadow:0 3px 0 #a66b00,0 4px 8px rgb(0 0 0 / 18%)!important}
      .guandan-private-zone>.guandan-play-actions>.guandan-pass-action{left:auto!important;right:14px!important;border-color:#d9f5ff!important;background:linear-gradient(180deg,#7ee2ff 0%,#23b9ef 100%)!important;color:#073d5a!important;box-shadow:0 3px 0 #086a9d,0 4px 8px rgb(0 0 0 / 18%)!important}
      .guandan-private-zone>.guandan-play-actions>.guandan-tribute-action,.guandan-private-zone>.guandan-play-actions>.guandan-tribute-waiting{left:14px!important;right:14px!important;width:auto!important;border-color:#fff0a5!important;background:linear-gradient(180deg,#ffe16a 0%,#ffb313 100%)!important;color:#4b2b00!important;box-shadow:0 3px 0 #a66b00,0 4px 8px rgb(0 0 0 / 18%)!important}
      ...
      @media(max-width:900px){.guandan-private-zone{grid-template-columns:minmax(0,2fr) minmax(240px,1fr)!important}.guandan-private-zone>.guandan-play-actions{padding:72px 8px 8px!important}.guandan-private-zone>.guandan-play-actions>button{width:calc(50% - 12px)!important;height:42px!important;min-height:42px!important;max-height:42px!important;font-size:.98rem!important}.guandan-private-zone>.guandan-play-actions>.guandan-play-action{left:8px!important}.guandan-private-zone>.guandan-play-actions>.guandan-pass-action{right:8px!important}.guandan-private-zone>.guandan-play-actions>.guandan-tribute-action,.guandan-private-zone>.guandan-play-actions>.guandan-tribute-waiting{left:8px!important;right:8px!important;width:auto!important}.guandan-selected-preview-card{width:72px;min-width:72px;height:102px;margin-top:-60px}}
    `}</style>
  );
