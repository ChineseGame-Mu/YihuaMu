...
fn ace_low_is_legal_and_five_high() {
    let ace_low = straight([Rank::Ace, Rank::Two, Rank::Three, Rank::Four, Rank::Five]);
    let six_high = straight([Rank::Two, Rank::Three, Rank::Four, Rank::Five, Rank::Six]);
...
fn ten_to_ace_is_the_highest_natural_straight() {
    let nine_high = straight([Rank::Five, Rank::Six, Rank::Seven, Rank::Eight, Rank::Nine]);
    let ace_high = straight([Rank::Ten, Rank::Jack, Rank::Queen, Rank::King, Rank::Ace]);
...
fn wraparound_sequences_are_rejected() {
    let jqka_two = straight([Rank::Jack, Rank::Queen, Rank::King, Rank::Ace, Rank::Two]);
    let jqka_three = straight([Rank::Jack, Rank::Queen, Rank::King, Rank::Ace, Rank::Three]);
